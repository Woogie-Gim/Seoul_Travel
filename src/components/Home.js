      ...
      <div class="scroll-section">
        <Fade direction="left">
          <p className="description">
            <strong>서울</strong>
            서울은 아름다운 역사와 현대가 공존하는 도시로, 독특한 매력과 다양한 경험을 제공합니다.<br></br>
            서울은 600년 이상의 역사를 자랑하는 고궁들과 전통 시장에서 현대적인 상업지구까지 다양한 얼굴을 갖추고 있어요. 한국 전통 문화의 중심지인 경복궁과 창덕궁은 아름다운 건축물과 정원이 눈에 띄며, 서울의 역사적인 흔적을 만날 수 있어요.
